...
local GraphicElement = require 'howl.LuaModules.Graphics.GraphicElement'
...
function Canvas:CreateImage(imageElementName, rect, imageSource)
    local image = GraphicElement:CreateImage(imageElementName, rect, imageSource)
    Canvas:addObjectToCanvas(image)
end
